...
"""
    ...
    def build_utility_from_discovery(self, tool_info):
        ...
        # Generate simple utility code - COMPLETELY FIXED VERSION
        tool_name = tool_info['name']
        tool_url = tool_info['url']
        tool_stars = tool_info['stars']
        tool_category = tool_info['category']
        tool_purpose = tool_info['potential_use']
        current_time = datetime.now().isoformat()
        
        utility_code = f"""# {tool_name} Inspired Utility
# Generated by Enhanced Eliza on {current_time}
# Inspired by: {tool_url} ({tool_stars} stars)
